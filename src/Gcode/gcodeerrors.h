...
#define YA_CAN_NOT_CALLED_HERE ("CmdParser::read_set_parameter can not called here")
...
#define YA_BUG_CODE_NOT_G0_OR_G1 ("Bug code not G0 or G1")
#define YA_BUG_CODE_NOT_G2_OR_G3 ("Bug code not G2 or G3")
#define YA_BUG_IN_TOOL_RADIUS_COMP ("Bug in tool radius comp")
#define YA_BUG_PLANE_NOT_XY_YZ_OR_XZ ("Bug plane not XY YZ or XZ")
...
#define YA_BUG_UNKNOWN_OPERATION ("Bug unknown operation")
...
#define YA_TOOL_RADIUS_NOT_LESS_THAN_ARC_RADIUS_WITH_COMP _("Tool radius must be less than arc radius with comp")
#define YA_TWO_G_CODES_USED_FROM_SAME_MODAL_GROUP _("Two G codes used from same modal group: G%d and G%d")
