...
#define NCE_ALL_AXES_MISSING_WITH_G52_OR_G92  _("All axes missing with g52 or g92")
...
#define YM_R_I_J_K_WORDS_ALL_MISSING_FOR_ARC _("R i j k words all missing for arc")
