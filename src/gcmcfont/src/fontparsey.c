...
{
       0,     0,     3,     4,     6,     8,    11,    16,    19,    21,
      24,    27,    30,    33,    35,    38,    44
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      16,     0,    -1,    -1,    17,    -1,    18,    -1,    17,    18,
      -1,    19,     8,    20,     9,    -1,     3,     7,    -1,    21,
      -1,    20,    21,    -1,     4,     7,    -1,     5,     7,    -1,
       6,    22,    -1,    23,    -1,    22,    23,    -1,    10,     7,
      11,     7,    12,    -1,    13,     7,    11,     7,    14,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    68,    68,    69,    72,    73,    76,    79,    82,    83,
...
{
  "$end", "error", "$undefined", "tGLYPH", "tLEFT", "tRIGHT", "tSTROKE",
  "tNUMBER", "'{'", "'}'", "'('", "','", "')'", "'['", "']'", "$accept",
  "file", "glyphs", "glyph", "glyphid", "bodies", "body", "coords",
  "coord", YY_NULL
};
#endif
...
{
       2,     0,     0,     3,     4,     0,     7,     1,     5,     0,
       0,     0,     0,     0,     8,    10,    11,     0,     0,    12,
      13,     6,     9,     0,     0,    14,     0,     0,     0,     0,
      15,    16
};
...
{
       1,     4,    10,     1,    -8,     5,    -8,    -8,    -8,     3,
       7,     8,    -7,    -4,    -8,    -8,    -8,     9,    11,    -7,
      -8,    -8,    -8,     6,    12,    -8,    13,    14,     0,    15,
      -8,    -8
};
...
{
      10,    11,    12,    17,     1,    21,    18,    10,    11,    12,
       7,     6,    30,     9,    15,    16,    23,    26,    24,     8,
      28,    29,     0,    27,     0,     0,     0,     0,     0,    31,
      22,     0,     0,     0,     0,     0,     0,    25
};
...
{
       4,     5,     6,    10,     3,     9,    13,     4,     5,     6,
       0,     7,    12,     8,     7,     7,     7,    11,     7,     3,
       7,     7,    -1,    11,    -1,    -1,    -1,    -1,    -1,    14,
      13,    -1,    -1,    -1,    -1,    -1,    -1,    19
};
...
{
       0,     3,    16,    17,    18,    19,     7,     0,    18,     8,
       4,     5,     6,    20,    21,     7,     7,    10,    13,    22,
      23,     9,    21,     7,     7,    23,    11,    11,     7,     7,
      12,    14
};
  ...
  switch (yyn)
    {
        case 4:
/* Line 1792 of yacc.c  */
#line 72 "fontparsey.y"
    { glyph_add((yyvsp[(1) - (1)].g)); }
    break;

  case 5:
/* Line 1792 of yacc.c  */
#line 73 "fontparsey.y"
    { glyph_add((yyvsp[(2) - (2)].g)); }
    break;

  case 6:
/* Line 1792 of yacc.c  */
#line 76 "fontparsey.y"
    { (yyval.g) = curglyph; glyph_check(); curglyph = NULL; }
    break;

  case 7:
/* Line 1792 of yacc.c  */
#line 79 "fontparsey.y"
    { glyph_new((yyvsp[(2) - (2)].i)); }
    break;

  case 10:
/* Line 1792 of yacc.c  */
#line 86 "fontparsey.y"
    { curglyph->left = (yyvsp[(2) - (2)].i); curflags |= GF_LEFT; }
    break;

  case 11:
/* Line 1792 of yacc.c  */
#line 87 "fontparsey.y"
    { curglyph->right = (yyvsp[(2) - (2)].i); curflags |= GF_RIGHT; }
    break;

  case 12:
/* Line 1792 of yacc.c  */
#line 88 "fontparsey.y"
    { stroke_add((yyvsp[(2) - (2)].s)); }
    break;

  case 13:
/* Line 1792 of yacc.c  */
#line 91 "fontparsey.y"
    { (yyval.s) = coords_new((yyvsp[(1) - (1)].c)); }
    break;

  case 14:
/* Line 1792 of yacc.c  */
#line 92 "fontparsey.y"
    { (yyval.s) = coords_add((yyvsp[(1) - (2)].s), (yyvsp[(2) - (2)].c)); }
    break;

  case 15:
/* Line 1792 of yacc.c  */
#line 95 "fontparsey.y"
    { (yyval.c).x = (yyvsp[(2) - (5)].i); (yyval.c).y = (yyvsp[(4) - (5)].i); (yyval.c).flags = CFL_DISCONT; }
    break;

  case 16:
/* Line 1792 of yacc.c  */
#line 96 "fontparsey.y"
    { (yyval.c).x = (yyvsp[(2) - (5)].i); (yyval.c).y = (yyvsp[(4) - (5)].i); (yyval.c).flags = 0; }
    break;


/* Line 1792 of yacc.c  */
#line 1456 "fontparsey.c"
      default: break;
    }
